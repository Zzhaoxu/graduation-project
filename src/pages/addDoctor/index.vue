  ...
  <div class="container">
    ...
    <div class="form">
      ...
      <van-checkbox-group class="info" @change= "weekSelect" v-model="weekWork" direction="horizontal">
        <van-checkbox name="星期一">星期一</van-checkbox>
        <van-checkbox name="星期二">星期二</van-checkbox>
        <van-checkbox name="星期三">星期三</van-checkbox>
        <van-checkbox name="星期四">星期四</van-checkbox>
        <van-checkbox name="星期五">星期五</van-checkbox>
        <van-checkbox name="星期六">星期六</van-checkbox>
        <van-checkbox name="星期日">星期日</van-checkbox>
      </van-checkbox-group>
      <!-- 所属科室 -->
      <div @tap="showTPopup">
      ...
      <!-- 上传照片 -->
      <div v-if="photoUrl" class="img">
        <img class="myimg" :src="photoUrl" alt="">
      </div>
      <van-button v-else  @tap="upImage">上传照片</van-button>
